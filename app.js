...
function showResult(lat, lng, plot, shortId, substInfo) {
    ...
    html += `
        ...
        <div class="map-links">
            <a class="map-link" href="https://www.arcgis.com/apps/mapviewer/index.html?url=https://eservices.dls.moi.gov.cy/arcgis/rest/services/National/CadastralMap_EN/MapServer&center=${lng},${lat}&level=18" target="_blank">
                🏛️ DLS Cadastral Map
            </a>
